 ...
 * Standalone helper functions for app location enforcement, debug info,
 * GitHub issue reporting, launch tracking, and app state predicates.
 */
...
import { openExternal } from '../security/shellWrapper.js';
