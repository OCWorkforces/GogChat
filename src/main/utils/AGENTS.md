...
| `performanceMonitor.ts`        | ~450  | Startup timing + memory snapshots + renderer/IPC/memory latency samples                                                                                                                                                                                                    | `getPerformanceMonitor()`                                         |
...
| `performanceTypes.ts`          | ~155  | Canonical: `PERFORMANCE_TARGETS`, memory/renderer/IPC latency sample types, `PerformanceMetrics`, `PerformanceMonitorReader`                                                                                                                                               | exported types/const                                              |
